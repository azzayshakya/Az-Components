...
export default function HomeWithAntdTableAndForm() {
  ...
  return (
    <div style={{ padding: '' }}>
      <ModeCard title="Student Form" extra={<Button type="primary">Close</Button>}>
        <Form layout="horizontal" labelCol={{ xs: 24, sm: 8 }} wrapperCol={{ xs: 24, sm: 16 }}>
      ...
      <ModeCard title="Dashboard Statistics">
        <Row gutter={16}>
          <Col span={8}>
            <ModeFieldSet title="Total Users" size="small" className="fieldset-primary">
          ...
          <Col span={8}>
            <ModeFieldSet title="Messages" size="small" className="fieldset-success">
              <div style={{ textAlign: 'center', padding: '20px 0' }}>
          ...
          <Col span={8}>
            <ModeFieldSet title="Organizations" size="small" className="fieldset-warning">
              <div style={{ textAlign: 'center', padding: '20px 0' }}>
