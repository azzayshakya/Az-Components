...
import { UserOutlined, MailOutlined, PhoneOutlined, IdcardOutlined, TeamOutlined, ApartmentOutlined } from "@ant-design/icons";
          ...
          {selectedRole !== userData.role && (
            <div className="role-change-notice">
              <span style={{ color: '#fa8c16' }}>
                Role will be changed from <strong>{userData.role}</strong> to <strong>{selectedRole}</strong>
              </span>
            </div>
          )}
        </div>
